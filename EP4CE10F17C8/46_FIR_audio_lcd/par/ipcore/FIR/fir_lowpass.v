...
module fir_lowpass (
	...
	output	[33:0]	ast_source_data;
	output		ast_sink_ready;
	output		ast_source_valid;
	output	[1:0]	ast_source_error;


	fir_lowpass_ast	fir_lowpass_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="fir_lowpass_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="160528.12445959382"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "output_bit_width" value="34"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Floating, Low Pass, Hamming, 32, 48000.0, 5000.0, 3750000.0, 0, -0.00108127, -1.25474E-4, 0.00153947, 0.00391886, 0.00584447, 0.00498863, -8.45609E-4, -0.0116248, -0.0234512, -0.0287715, -0.0189862, 0.0113637, 0.0608075, 0.119709, 0.172702, 0.20412, 0.20412, 0.172702, 0.119709, 0.0608075, 0.0113637, -0.0189862, -0.0287715, -0.0234512, -0.0116248, -8.45609E-4, 0.00498863, 0.00584447, 0.00391886, 0.00153947, -1.25474E-4, -0.00108127"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "number_of_sets" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_full_bit_width" value="34"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="2716"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fir_lowpass.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
