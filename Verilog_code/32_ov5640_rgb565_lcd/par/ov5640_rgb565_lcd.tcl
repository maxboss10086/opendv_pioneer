...
# File: ov5640_rgb565_lcd.tcl
# Generated on: Wed Nov 07 09:39:22 2018
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "ov5640_rgb565_lcd"]} {
		puts "Project ov5640_rgb565_lcd is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists ov5640_rgb565_lcd]} {
		project_open -revision ov5640_rgb565_lcd ov5640_rgb565_lcd
	} else {
		project_new -revision ov5640_rgb565_lcd ov5640_rgb565_lcd
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "11:08:24  NOVEMBER 04, 2018"
	...
	set_global_assignment -name SDC_FILE ov5640_rgb565_lcd.out.sdc
	...
	set_global_assignment -name VERILOG_FILE ../rtl/ov5640_rgb565_lcd.v
	...
	set_global_assignment -name TOP_LEVEL_ENTITY ov5640_rgb565_lcd
